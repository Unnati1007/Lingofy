...
const LoginPage = () => {
  ...
  return (
    <div className="auth-container">
      ...
      <div style={{ position: 'absolute', top: '20%', left: '50%', transform: 'translateX(-50%)', width: '500px', height: '300px', background: 'radial-gradient(circle, rgba(32, 190, 255, 0.08) 0%, transparent 70%)', pointerEvents: 'none' }} />
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', marginBottom: '24px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginTop: '12px' }}>
            <h1 style={{ fontSize: '22px', fontWeight: '800', margin: 0, color: '#fff' }}>Welcome Back</h1>
          ...
          <p style={{ fontSize: '13px', opacity: 0.6, margin: '4px 0 0 0' }}>Tune in and continue your learning rhythm</p>
        </div>
