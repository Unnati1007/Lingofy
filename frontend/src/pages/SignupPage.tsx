      ...
      <div className="auth-split-wrapper">
        ...
        >
          ...
          <div>
            ...
            <p style={{ fontSize: '15px', color: 'rgba(255,255,255,0.65)', margin: 0, lineHeight: 1.6, maxWidth: '440px' }}>
              Master languages through songs you love. Learn real-world vocabulary, pronunciation, and rhythm effortlessly.
            </p>
          </div>
          ...
          <div className="auth-hero-features">
            <div className="auth-feature-card">
              ...
              <div>
                <div style={{ fontSize: '14px', fontWeight: '700', color: '#fff' }}>Learn with Real Music</div>
                <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.5)', marginTop: '2px' }}>Synchronized lyrics & dual-language translations</div>
              </div>
            </div>
            ...
            <div className="auth-feature-card">
              ...
              <div>
                <div style={{ fontSize: '14px', fontWeight: '700', color: '#fff' }}>Interactive Gamified Lessons</div>
                <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.5)', marginTop: '2px' }}>Fill-in-the-blanks, pronunciation and smart AI tests</div>
              </div>
            </div>
            ...
            <div className="auth-feature-card">
              ...
              <div>
                <div style={{ fontSize: '14px', fontWeight: '700', color: '#fff' }}>Track Daily Progress</div>
                <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.5)', marginTop: '2px' }}>Maintain streaks, earn badges and climb learning tiers</div>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          <div style={{ width: '100%', marginBottom: '20px' }}>
            <h2 style={{ fontSize: '20px', fontWeight: '800', color: '#fff', margin: 0 }}>Create Account</h2>
            <p style={{ fontSize: '13px', color: 'rgba(255,255,255,0.5)', margin: '4px 0 0 0' }}>Get started with your free musical learning account</p>
          </div>
